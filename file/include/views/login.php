...
<div id="logo" class="user_avatar">
<a href="<?php echo gatorconf::get('base_url')?>"><img alt="filegator" src="<?php echo gatorconf::get('base_url')?>/include/views/img/login-only.png"></a>
</div>
