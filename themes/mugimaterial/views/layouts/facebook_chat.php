 ...
 */
 function live_chat_facebook($page, $domain = "") {
    ...
    define("LIVE_CHAT_FACEBOOK_TITLE", "Chat Support");
    define("LIVE_CHAT_FACEBOOK_TEXT", "Hello! Thanks for visiting us. Please press Start button to chat with our support :)");
    define("LIVE_CHAT_FACEBOOK_START", "Start");
    define("LIVE_CHAT_FACEBOOK_LANG", "en_US");
    ?>
    <link rel="stylesheet" type="text/css" href="<?php echo $domain ?>/assets/facebook/css/live_chat_facbook.css" >
    <script type="text/javascript" src="<?php echo $domain ?>/assets/facebook/js/live_chat_facbook.js"></script>
    <style type="text/css">
    ...
    <div id="b-c-facebook" class="chat_f_vt">
    	<div id="chat-f-b" onclick="b_f_chat()" class="chat-f-b">
    		<img class="chat-logo" src="<?php echo $domain ?>/assets/facebook/images/facebook.png" alt="logo chat" />
    		<label>
            ...
            */
            ...
            ?>
    		<div id="t_f_chat">
    			<a title="Close Chat" href="javascript:;" onclick="chat_f_close()" id="chat_f_close" class="chat-left-5"><img src="<?php echo $domain ?>/assets/facebook/images/close.png" alt="Close chat" title="Close chat" /></a>
    		</div>
    	</div>
